class eng:
    ...
    enum_key_pieces = ['I', 'a', 'm', 'k', 'e', 'y', ''];

class ru:
    enum_attributes = ['проницательность', 'настойчивость', 'адаптивность', 'анализ', 'знание', 'любовь', 'сила воли'];
    enum_passwords = ['лормастер', 'песни', 'майнкрафт', 'карта', 'инглиш', 'судьба', 'да'];
    enum_entry_text = [
        "ты нашел секрет!",  # +  "+1 insight",
        "Терпение и труд!",  # +  "+1 persistence",
        "Адаптируйся, выживай, превозмогай",  # +  "+1 adaptiveness",
        "Хитро!",  # +  "+1 analysis",
        "шпрехен зи инглиш",  # +  "+1 knowledge",
        "*( ͡° ͜ʖ ͡°)*",  # +  "+1 love",
        "Он сказал да!",  # +  "+1 willpower"
    ];
    enum_riddles = ["прослушай песни",
                    "иди на сервер в майнкрафте",
                    "Реши карту, вложенную в скетчбук",
                    "Что-то на английском",
                    "Загадка про судьбу",
                    "Ссылка на гугл диск с комиксом",
                    "Подсказка, что финальный ключ это ключ vigenere"
                    ];
