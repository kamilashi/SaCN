...
и ты, отважился на испытание чтобы найти свое счастье. Каждое испытание - это загадка, награда за решение\n\
которой поможет продвигаться дальше. Мы создадим историю, ни одна деталь которой не будет утеряна,\n\
...
Уровень 1 пройден, Нухрат получает: \n",  # +   +1 insight
    ...
    enum_riddles = ["загадка про слово",
                    ...
                    "Подсказка, что финальный ключ это ключ vigenere, написанный на русском в английской раскладке"
                    ];
    enum_key_pieces = ['I', 'a', 'm', 'k', 'e', 'y', '_'];
